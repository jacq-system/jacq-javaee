 ...
 */
@Path("/seedExchange")
public interface SeedExchangeService {

    /**
     * Retrieve a single seed order entry by id
     *
     * @param seedOrderId
     * @return
     */
    ...
    public SeedOrderResult find(@QueryParam("seedOrderId") Long seedOrderId);
    ...
    /**
     * Update or Add Seed Order
     *
     * @param seedOrderResult
     * @return
     */
    @POST
    @Path("/save")
