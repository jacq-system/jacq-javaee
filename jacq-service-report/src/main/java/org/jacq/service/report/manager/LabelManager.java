...
public class LabelManager {
    ...
    public Response getWork(String type, Long derivativeId) throws EngineException {
        List<BotanicalObjectDerivative> results = this.derivativeSerive.find(type, derivativeId, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
