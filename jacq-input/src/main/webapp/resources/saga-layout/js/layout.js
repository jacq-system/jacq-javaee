/**
 * PrimeFaces Saga Layout
 */
PrimeFaces.widget.Saga = PrimeFaces.widget.BaseWidget.extend({
    ...
    init: function(cfg) {
        ...
        this.menuButton = $('#saga-menu-button');
    ...
    saveMenuState: function() {
        $.cookie('saga_expandeditems', this.expandedMenuitems.join(','), {path: '/'});
    },

    clearMenuState: function() {
        $.removeCookie('saga_expandeditems', {path: '/'});
    },

    saveProfileMenuState: function() {
        $.cookie('saga_profile_expanded', "1", {path: '/'});
    },

    clearProfileMenuState: function() {
        $.removeCookie('saga_profile_expanded', {path: '/'});
    },

    restoreMenuState: function() {
        var menucookie = $.cookie('saga_expandeditems');
        if (menucookie) {
        ...
        var profileMenuCookie = $.cookie('saga_profile_expanded');
